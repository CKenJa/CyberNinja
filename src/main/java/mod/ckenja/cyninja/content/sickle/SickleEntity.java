...
public class SickleEntity extends ThrowableItemProjectile {
    ...
    private static final EntityDataAccessor<Holder<Action>> NINJA_ACTION = SynchedEntityData.defineId(SickleEntity.class, ModEntityDataSerializer.NINJA_ACTION.get());
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(NINJA_ACTION, registryAccess().lookupOrThrow(ActionRegistry.NINJA_ACTIONS_REGISTRY).getOrThrow(NinjaActions.SICKLE_ATTACK.getKey()));
    }
    ...
    public void readAdditionalSaveData(CompoundTag nbt) {
        ...
        Optional.ofNullable(ResourceLocation.tryParse(nbt.getString("ninja_action")))
                .map(location -> ResourceKey.create(ActionRegistry.NINJA_ACTIONS_REGISTRY, location))
                .flatMap(key -> registryAccess().lookupOrThrow(ActionRegistry.NINJA_ACTIONS_REGISTRY).get(key))
    ...
    public void setNinjaAction(Holder<Action> ninjaAction) {
        entityData.set(NINJA_ACTION, ninjaAction);
    }

    public Holder<Action> getNinjaAction() {
