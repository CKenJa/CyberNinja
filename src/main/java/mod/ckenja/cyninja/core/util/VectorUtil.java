...
public class VectorUtil {
    public static void moveToLookingWay(LivingEntity livingEntity, float speed, Holder<Action> ninjaActionHolder) {
    ...
    public static void moveToYRotLookingWay(LivingEntity livingEntity, float speed, Holder<Action> ninjaActionHolder) {
    ...
    public static void moveRelativeActionY(LivingEntity livingEntity, float p_19921_, Vec3 p_19922_) {
        Vec3 vec3 = getInputVector(p_19922_, p_19921_, livingEntity.getData(ModAttachments.STATES).getActionYRot());
