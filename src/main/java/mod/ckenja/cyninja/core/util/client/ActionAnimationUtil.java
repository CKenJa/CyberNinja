package mod.ckenja.cyninja.core.util.client;
...
public class ActionAnimationUtil {
    ...
    public static void animationWalkWithHeadRotation(BagusModelEvent.PostAnimate event, AnimationDefinition animationDefinition, Holder<Action> ninjaActions, float scale, float speed) {
    ...
    public static void animationWalkWithHandHeadRotation(BagusModelEvent.PostAnimate event, AnimationDefinition animationDefinition, Holder<Action> ninjaActions, float scale, float speed) {
        Entity entity = event.getEntity();
        IRootModel rootModel = event.getRootModel();
        if (entity instanceof LivingEntity livingEntity) {
            if (event.isSupportedAnimateModel()) {
