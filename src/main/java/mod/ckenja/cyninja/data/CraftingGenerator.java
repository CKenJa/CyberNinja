...
public class CraftingGenerator extends CraftingDataHelper {
    ...
    protected void buildRecipes(RecipeOutput consumer) {
        ...
        SmithingTrimRecipeBuilder.smithingTrim(Ingredient.of(ModItems.CYBER_TRIM_SMITHING_TEMPLATE), Ingredient.of(ModItems.SHURIKEN), Ingredient.of(ItemTags.TRIM_MATERIALS), RecipeCategory.COMBAT).unlocks("has_item", has(ModItems.CYBER_TRIM_SMITHING_TEMPLATE)).save(consumer, prefix("cyber_shuriken"));
