...
public class ModEntityDataSerializer {
    ...
    public static final DeferredHolder<EntityDataSerializer<?>, EntityDataSerializer<Holder<Action>>> NINJA_ACTION = DATA_SERIALIZERS.register("ninja_action", () -> EntityDataSerializer.forValueType(ByteBufCodecs.holderRegistry(ActionRegistry.NINJA_ACTIONS_REGISTRY)));
}